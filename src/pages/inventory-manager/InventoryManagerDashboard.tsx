...
import { Archive as ArchiveIcon, ShieldAlert, CheckCircle, List, Plus, Activity } from "lucide-react";
...
export default function InventoryManagerDashboard() {
  ...
  const { data: stats, isLoading } = useQuery<Stats>({
    ...
    queryFn: async () => {
      ...
      const maintenanceCount = allStatuses.filter(s => s === "maintenance").length;
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <div>
              <h3 className="font-semibold text-gray-900">View All Equipment</h3>
              <p className="text-sm text-gray-500">
